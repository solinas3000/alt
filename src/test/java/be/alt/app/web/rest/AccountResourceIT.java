...
import be.alt.app.IntegrationTest;
import be.alt.app.config.Constants;
import be.alt.app.domain.User;
import be.alt.app.repository.AuthorityRepository;
...
import be.alt.app.service.dto.PasswordChangeDTO;
import be.alt.app.web.rest.vm.KeyAndPasswordVM;
import be.alt.app.web.rest.vm.ManagedUserVM;
